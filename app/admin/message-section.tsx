...
export function MessageSection({ repairId, messages, canUpdate, lineUnavailable }: { repairId: number; messages: TenantRepairMessage[]; canUpdate: boolean; lineUnavailable?: boolean }) {
