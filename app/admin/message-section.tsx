...
export function MessageSection({ repairId, messages, canUpdate, lineUnavailable, replyScope = "" }: { repairId: number; messages: TenantRepairMessage[]; canUpdate: boolean; lineUnavailable?: boolean; replyScope?: string }) {
